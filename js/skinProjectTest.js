...
function skin() {
    ...
    if (result.matches) {
        ...
        var otoUp = 'images/toright.png'
        var otwitter = 'images/twitter2.png'
        var ofacebook = 'images/facebook2.png'
        oBtnPhone.onclick = function(){
            if(n%2 === 0){
                ...
                otoUp = 'images/toright2.png'
                otwitter = 'images/twitter.png'
                ofacebook = 'images/facebook.png'
            }else{
                sty = 'css/morning.css'
                ...
                otoUp = 'images/toright.png'
                otwitter = 'images/twitter2.png'
                ofacebook = 'images/facebook2.png'
            }
            ...
            toUp.setAttribute('src',otoUp)
            twitter.setAttribute('src',otwitter)
            facebook.setAttribute('src',ofacebook)
            n++
        }
    } else {
        // PC端
